...
def update(rt: NpOptiX)->None:
    print(params.n)
    rt.update_data("obj1", pos = obj1_list[params.n])
...
optix.set_data("obj1", pos=obj1_list[0],  c=make_color(0.8, 0.8, 0.8),geom='ParticleSet',r=0.1)
...
optix.encoder_start("simple_cloth_3_kp.mp4", params.fps * params.duration)
