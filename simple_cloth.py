...
simulator.Initialize(init_vertices, elements, 1e3, 1e5, 0.3)
print("Initialization finished.")

for j in range(X + 1):
    simulator.dirichlet_boundary_condition[2 * j] = ti.Vector([0.0, 0.0, 0.0])
    simulator.dirichlet_boundary_condition[2 * j + 1] = ti.Vector([0.0, 0.0, dx])
